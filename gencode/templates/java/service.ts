...
public interface ${model.entityName}Service {
     ...
     * @return
     */
    File export${model.entityName}DataTable(HttpServletRequest req, ${model.entityName}Form form) throws Exception, SysException;
...
`
UtilsFile.writeFile(`/com.viettel.ctct/service-political/src/main/java/com/viettel/crm/service`, `/${model.entityName}Service.java`, contentFile);
};
